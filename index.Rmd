...
data <- data.frame(
  id      = 1:8,
  content = c("Loi CADA","Directive PSI", "Directive INSPIRE", "Révision de la directive PSI", "Loi Notre", "Loi Valter", "Loi pour une République Numérique", "La circulaire du 27/04/2021"),
  start   = c("1978-07-17","2003-11-17", "2007-03-14","2013-06-13","2015-08-07","2015-12-28","2016-10-07","2021-04-27")
)
timevis(data, loadDependencies = FALSE, width = "715px", height = "420px")
```

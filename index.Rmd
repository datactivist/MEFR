...
**La France se classe ainsi quatrième** selon le dernier classement (2015) de l’Open Data Index établi par l’Open Knowledge Foundation, derrière Taïwan, l’Australie et la Grande-Bretagne.
...
**[Le baromètre international de l'Open Data](https://index.okfn.org/place/)** est un outil d'évaluation pays par pays de la façon dont les gouvernements publient et utilisent des données ouvertes pour la gestion de l'Etat, l'innovation et l'impact social. **La France y obtient la note de 85,13 sur 100 en 2016.**
...
La première brique du droit d'accès aux documents administratifs est posée dès la Déclaration des Droits de l'Homme est du Citoyen avec larticle 15 : "La société a le droit de demander  compte à tout agent public de son administration".

Il s'agit de réduire les asymétries d'information en accédant au matériau brut de l'information et du savoir
...
---
### .red[Le programme] de la formation

Retrouvons-nous le 18 Janvier 2022 pour un temps de formation pratique sur

...
params:
  ...
  slug: ministere-de-leconomie-des-finances-et-de-la-relance
---
...
---
Vous allez participer à la formation "Les fondamentaux de l’Open Data avant d’ouvrir les données sur data.economie.gouv.fr
...
# 2. L'histoire de l'Open Data dans le monde
...
* **La France se classe ainsi quatrième** selon le dernier classement (2019) de l’Open Data Index établi par l’Open Knowledge Foundation, derrière Taïwan, l’Australie et la Grande-Bretagne.

* L’année 2016-2017, **la France prend la présidence du Partenariat pour le Gouvernement Ouvert**, une organisation internationale ayant pour objet de promouvoir une gouvernance co-construite entre citoyens et administrations et qui promeut l'ouverture des données comme outil d'information et de participation aux décisions publiques. (*Nous y reviendrons également*)


---

### .red[Le baromètre international] de l'open data
...
![baromètre international de l'Open Data](./img/odb.png)
---

### .red[L'Open Data Index] de l'Open Knowledge Foundation

![Open Data Index de l'Open Knowledge Foundation](./img/odi.png)
...
# 3. Le déploiement de l'Open Data en France
...
---
### .red[Les données à particulièrement exclure] du périmètre de l'open data

**Les informations sur lesquelles des tiers détiennent des droits de propriété intellectuelle**

* Exemple : 
Vous voulez publier des images ? Il faut s'assurer d'abord que :

> * 1 / les oeuvres représentées sur ces images appartienent au domaine public
> * 2 / vérifier les droits d'auteur du/de la photographe 
> * 3 / vérifier si un contrat de cession existe entre l'établissement et le/la photographe
> * 4 / vérifier si les métadonnées contiennent une "description longue"
d'une notice où un droit d'auteur s'applique (le droit d'auteur de l'agent public)

Vous pouvez vous aider de [cet outil](https://www.culture.gouv.fr/droitsdediffusion/) qui facilite  la compréhension des droits de propriété littéraire et artistique applicables aux contenus culturels dont la diffusion est souhaitée.
...
.center[<img src="https://datactivist.coop/uploads/taberror.jpg" height="350"/>]

---

### [.red[Facette n°4 :]](https://books.openedition.org/cdf/5005?lang=fr) les industries de la donnée
...
### Selon vous, quelle facette et la plus porteuse actuellement ?

#### A - La transparence
#### B - La libre circulation de l'information
#### C - La demande de données brutes
#### D - Les industries de la données
#### E - La modernisation des administrations

---

class: inverse, center, middle

# Les principaux enjeux de l'open data 
...
* Exemple avec les **Données essentielles des conventions de subvention**, année 2018

<img src="./img/donnees_conventions_subvention.png" height="300"/>
...
### Quel enjeu vous semble le meilleur levier pour convaincre ?

#### A - La transparence de la vie publique et la participation citoyenne à l'action publique
#### B - L'efficacité de l'action publique
#### C - Le développement de l'attractivité des territoires
#### D - Le soutien à l'innovation économique et sociale
#### E - La démocratisation culturelle et la transmission des savoirs

---
### Le .red[Programme] de la formation

#### Les fondamentaux de l’Open Data avant d’ouvrir les données sur data.economie.gouv.fr

...
* La feuille de route comprend 25 actions planifiées entre 2020 et 2022 qui s’articulent autour de 3 axes ; capital humain, architecture et gouvernance. 
...
* organisation d’évènements d’acculturation : cycle de formation open data, rendez-vous participatifs réunisssant la communauté open data du MEFR comme la Non Conférence édition 2020 et 2021
* identification de nouvelles données d'intérêt

![Les chiffres clés de data.economie.gouv.fr, la plate-forme open data de Bercy](./img/bilan_dataeconomie.png)
